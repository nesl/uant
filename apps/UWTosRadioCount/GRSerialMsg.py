...
# This class implements a Python interface to the 'GRSerialMsg'
# message type.
#
...
class GRSerialMsg(tinyos.message.Message.Message):
    # Create a new GRSerialMsg of size 7.
