...
# This class implements a Python interface to the 'TapSerialMsg'
# message type.
#
...
class TapSerialMsg(tinyos.message.Message.Message):
    # Create a new TapSerialMsg of size 7.
